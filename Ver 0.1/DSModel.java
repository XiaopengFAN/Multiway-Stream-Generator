...
public class DSModel {
    ...
    public void useUserDefine(String key, int[] kArray, double[] probability){
        this.md = "UserDefine";
        this.key = key;
        this.userdefine = new UserDefine();
        userdefine.kArray = kArray;
        userdefine.probability = probability;
        userdefine.createUserDefineMap();
    }

    public void usePossion(String key, int lambda) {
        this.md = "Possion";
        this.key = key;
        this.possion = new Possion();
        possion.lambda = lambda;
    }
    ...
    public int startRamdomInt() {
        int randNum = 0;
        if (md == "Possion") {
            randNum = possion.generatePossion();
        } else if (md == "Zipf") {
            randNum = zipf.generateZipf();
        } else if (md == "UniformInt") {
            randNum = uniformint.generateUniformInt();
        } else if (md == "UserDefine") {
            randNum = userdefine.generateUserDefine();
        }
...
//        Final Part.   Return your result.
    ...
    private class UserDefine {
        private int[] kArray;
        private double[] probability;

        private void createUserDefineMap() {
            double cdf = 0;
            double check = 0;
        ...
        private int generateUserDefine(){
//            Use Map for generation
    ...
    private class Possion {
        private int lambda;
        private int generatePossion() {
//            Junhao, based on Knuth possion random
            final int STEP = 500;
